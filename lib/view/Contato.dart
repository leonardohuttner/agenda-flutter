...
import 'package:agenda/Controller/Validators.dart';
...
class _ContatosPageState extends State<ContatosPage> {
  ...
  _barraSuperior() {
    return AppBar(
      title: Text(_contatoTemporario.nome == ""
          ? "Novo Contato"
          : _contatoTemporario.nome),
    );
  }
  ...
  _camposInsercaoTexto(
      String textoLabel, String campo, TextEditingController controller) {
